#!/usr/bin/python3
"""the unit test for the square module"""
import io
import unittest
...
class TestSquare(unittest.TestCase):
    """the tests for the Base class template"""

    def setUp(self):
        """the method for the imports module, instantiates class"""
        Base._Base__nb_objects = 0

    def tearDown(self):
        """the method that cleans up after each test_method"""
        pass
