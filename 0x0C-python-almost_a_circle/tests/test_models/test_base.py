#!/usr/bin/python3
"""the base test module using unittest"""
import unittest
...
class TestBase(unittest.TestCase):
    ...
    def tearDown(self):
        """a func that cleans up after each test methods"""
        pass

    def test_A_nb_objects(self):
        """a func that test if nb_objects is a private attrs"""
